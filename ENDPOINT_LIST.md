...
5 endpoints: 2 reads exposed to Meditrac, 3 writes exposed only to our own artisans. Meditrac's
contract itself remains fully read-only — see "Design pivot" below.
